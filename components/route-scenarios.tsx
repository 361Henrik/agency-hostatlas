...
export function OperatorSection() {
  return (
    <section id="operators" className="py-32 px-6 bg-secondary">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="text-center mb-20 reveal">
          ...
          <h2 className="text-3xl font-medium tracking-tight md:text-4xl lg:text-5xl text-balance text-secondary-foreground mb-5">
        ...
        {/* Capabilities grid */}
        <div className="grid gap-px md:grid-cols-2 bg-accent/10 border border-accent/15 mb-16 reveal-stagger">
          {operatorCapabilities.map((cap, i) => (
            <div
              key={cap.title}
              className="p-8 bg-secondary flex flex-col reveal"
            >
        ...
        <div className="max-w-xl mx-auto text-center reveal">
          ...
          <p
            className="text-lg text-secondary-foreground/70 leading-relaxed italic text-pretty"
            style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
          >
            Your brand. Your editorial voice. Your approval on every detail.
            ThreeSixtyOne provides the capability. You retain full control
